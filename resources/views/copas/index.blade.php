...
<div class="row">
    ...
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-fw fa-pencil"></i> Copas</li>
        </ol>
    </div>
</div>
<div class="row">
    ...
    <div class="col-lg-2">
        <p class="text-right"><a href="{{ route('copas.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Nuevo</a></p>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                @foreach($copas as $copa)
                    <tr>
                        <td><a href="{{ route('copas.edit', codifica($copa->id) ) }}" title="Editar">{{ $copa->titulo }}</a></td>
                        <td>
