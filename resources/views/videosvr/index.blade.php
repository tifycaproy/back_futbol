...
<div class="row">
    ...
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-fw fa-pencil"></i> Video VR</li>
        </ol>
    </div>
</div>
<div class="row">
    ...
    <div class="col-lg-2">
        <p class="text-right"><a href="{{ route('videosvr.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Nuevo</a></p>
    </div>
</div>
            ...
            <table class="table table-bordered table-hover">
                ...
                @foreach($videosvr as $video)
                    <tr>
                        ...
                        <td><input name="agree" type="checkbox" value="{{$video->dorado}}" @if($video->dorado == true) checked=checked @endif disabled></td>
                        <td>
