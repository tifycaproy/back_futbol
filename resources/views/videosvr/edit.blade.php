...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <p class="text-right"><a href="{{ route('videosvr.index') }}" class="btn btn-sm btn-primary"><i
                            class="fa fa-fw fa-list"></i> Volver a la lista</a></p>
        </div>
    </div>
    <form role="form" action="{{ route('videosvr.update', codifica($video->id)) }}" method="POST"
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                    <label>Título</label>
                    <input type="text" class="form-control" name="titulo" value="{{ old('titulo', $video->titulo) }}"
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Video</label>
                    <input type="text" class="form-control" name="video" value="{{ old('video', $video->video) }}"
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <textarea name="descripcion"
                              class="form-control">{{ old('descripcion', $video->descripcion) }}</textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <select name="soloUsuariosDorados" class="form-control">
                        <option value="0" @if(old('soloUsuariosDorados', $video->dorado)=='0') selected @endif>
                            No
                        </option>
                        <option value="1" @if(old('soloUsuariosDorados', $video->dorado)=='1') selected @endif>
                            Si
                        </option>
                    </select>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <a href="{{ route('videosvr.index') }}" class="btn btn-primary"><i class="fa fa-fw fa-list"></i> Volver
                    a la lista</a> <a href="{{ route('videosvr.create') }}" class="btn btn-primary"><i
                            class="fa fa-fw fa-plus-circle"></i> Nuevo</a> <a
                        href="{{ route('videosvr_eliminar', codifica($video->id) ) }}" class="btn btn-danger"><i
                            class="fa fa-fw fa-ban"></i> Eliminar</a>
            </div>
        </div>
    </form>
