...
class ConfiguracionController extends Controller
{
    ...
    public function index()
    {
        ...
        $configuracion = Configuracion::first([
            ...
            'titulo_0_2','sub_titulo_2_1','sub_titulo_2_2','sub_titulo_2_3','sub_titulo_2_4','sub_titulo_2_5','boton_1_activo','boton_1_texto','boton_2_activo','boton_2_texto','tipo_popup','version_app','version_ios','version_android','url_av_villas'
        ]);
        $data["status"] = 'exito';
