...
class CalendarioFB extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calendariofb', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('formacion_id')->index();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('calendariofb');
